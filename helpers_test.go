...
func TestEscapeJSString_Backslash(t *testing.T) {
	got := escapeJSString(`a\b`)
	want := `a\\b`
	if got != want {
		t.Errorf("escapeJSString(%q) = %q, want %q", `a\b`, got, want)
	}
}

func TestEscapeJSString_SingleQuote(t *testing.T) {
	got := escapeJSString("it's")
	want := `it\'s`
	if got != want {
...
func TestEscapeJSString_DoubleQuote(t *testing.T) {
	got := escapeJSString(`say "hi"`)
	want := `say \"hi\"`
	if got != want {
		t.Errorf("got %q, want %q", got, want)
	}
...
func TestEscapeJSString_Newline(t *testing.T) {
...
func TestEscapeJSString_CarriageReturn(t *testing.T) {
	got := escapeJSString("a\rb")
	want := `a\rb`
	if got != want {
		t.Errorf("got %q, want %q", got, want)
	}
...
func TestEscapeJSString_NullByte(t *testing.T) {
	got := escapeJSString("a\x00b")
	want := `a\0b`
	if got != want {
		t.Errorf("got %q, want %q", got, want)
	}
...
func TestEscapeJSString_LineSeparator(t *testing.T) {
	got := escapeJSString("a\u2028b")
	want := `a\u2028b`
	if got != want {
		t.Errorf("got %q, want %q", got, want)
...
func TestEscapeJSString_ParagraphSeparator(t *testing.T) {
	got := escapeJSString("a\u2029b")
	want := `a\u2029b`
	if got != want {
		t.Errorf("got %q, want %q", got, want)
...
func TestEscapeJSString_CleanString(t *testing.T) {
	input := "hello world 123"
	got := escapeJSString(input)
	if got != input {
