...
// test that builds a default settings store (rooted at bridge.ConfigDir)
// cannot touch the real ~/Library/Application Support/relay.
//
...
func TestMain(m *testing.M) {
	...
	if err != nil {
		fmt.Fprintln(os.Stderr, "config tests: create sandbox home:", err)
		os.Exit(1)
	}
	os.Setenv("HOME", home)
