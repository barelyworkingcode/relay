...
// test that writes a CA or an enrolment bundle (both rooted at
// bridge.ConfigDir) cannot touch the real ~/Library/Application Support/relay.
//
...
func TestMain(m *testing.M) {
	home, err := os.MkdirTemp("", "enrolment-test-home-")
	if err != nil {
		fmt.Fprintln(os.Stderr, "enrolment tests: create sandbox home:", err)
		os.Exit(1)
	}
	os.Setenv("HOME", home)
