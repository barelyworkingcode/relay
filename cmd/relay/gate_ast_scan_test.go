...
// gateASTFiles returns every non-test .go file directly in the relay command
// source directory -- the same package-main source set
// gate_structural_test.go's mutation-containment scan walks.
