...
func startFrontendServerWith(t *testing.T, token string, enhanced *EnhancedServiceRegistry) string {
	...
	srv, err := NewFrontendServer(store, extMgr, extMgr, extMgr, seededEndpoint(t, store, sock, token), enhanced, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, sessionRouteDeps{})
	if err != nil {
