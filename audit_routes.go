...
func RegisterAuditRoutes(rr *RouteRegistrar, ops *AuditOps) {
	rr.Handle(ClassRead, "GET /api/audit", func(w http.ResponseWriter, r *http.Request) {
	...
	rr.Handle(ClassConfigure, "POST /api/audit/export", func(w http.ResponseWriter, r *http.Request) {
	...
	rr.Handle(ClassRead, "GET /api/audit/log", func(w http.ResponseWriter, r *http.Request) {
