...
**Modified:**
- `/Users/me/source/barelyworkingcode/relay/settings.go` — three new methods (RotateProjectToken, UpdateProjectDisabledTools, SetProjectGenerateSkill)
- `/Users/me/source/barelyworkingcode/relay/project_routes.go` — 3 new routes, new arg on `RegisterProjectRoutes`, `MCPToolsProvider` interface, `onChange` callback
- `/Users/me/source/barelyworkingcode/relay/ipc_handlers.go` — 7 new message constants, register handlers, extend `pushFullSettings`, add `pushFullProjects`, extend `IPCContext`
- `/Users/me/source/barelyworkingcode/relay/settings.html` — Projects tab UI (large)
- `/Users/me/source/barelyworkingcode/relay/settings_html.go` — placeholders + substitutions
- `/Users/me/source/barelyworkingcode/relay/trayapp.go` — wire seed cache + onChange + IPCContext fields
- `/Users/me/source/barelyworkingcode/relay/frontend_server.go` — pass new args through
- `/Users/me/source/barelyworkingcode/relay/CLAUDE.md` — Projects tab now exists; remove discrepancy

**New:**
- `/Users/me/source/barelyworkingcode/relay/ipc_projects.go`
- `/Users/me/source/barelyworkingcode/relay/ipc_projects_test.go`
- `/Users/me/source/barelyworkingcode/relay/settings_projects_test.go`
- `/Users/me/source/barelyworkingcode/relay/docs/decisions/004-project-mgmt-in-relay.md` (ADR)
