...
func (o *CredentialOps) Mint(ctx context.Context, req credentialMintRequest, via, credID string) (APICredential, string, error) {
...
func (o *CredentialOps) Revoke(ctx context.Context, id, via, credID string) (APICredential, error) {
